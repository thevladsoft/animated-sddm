    ...
    */
    ...
    PlasmaComponents.TextField {
        ...
        style: TextFieldStyle {
            textColor: "black"
            selectedTextColor: "gray"        // The highlighted text color
            selectionColor: "gray"           // The text highlight color
            placeholderTextColor:"gray"      // When the text field is empty
        ...
        style: ButtonStyle {
            background: Rectangle {
                ...
                gradient: Gradient {                                      //pressed   //normal
                    GradientStop { position: 0 ; color: control.pressed ? "black" : "gray" }
                    GradientStop { position: 1 ; color: control.pressed ? "gray" : "black" }
                }
                //implicitWidth: 100
                implicitHeight: 30
            }
