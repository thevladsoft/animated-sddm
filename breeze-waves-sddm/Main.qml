...
property string textcolors: "#23567d"
...
//             }
	...
	Timer {
            ...
            onTriggered: {
                fondo1.opacity = Math.random() > 0.5 ? (loginScreenRoot.uiVisible ? 0.7 : 1) : 0
		        fondo2.opacity = Math.random() > 0.5 ? (loginScreenRoot.uiVisible ? 0.7 : 1) : 0
		        fondo3.opacity = Math.random() > 0.5 ? (loginScreenRoot.uiVisible ? 0.7 : 1) : 0
		        fondo4.opacity = Math.random() > 0.5 ? (loginScreenRoot.uiVisible ? 0.7 : 1) : 0
            }
        }
