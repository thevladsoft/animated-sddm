    ...
    */
    ...
    PlasmaComponents.TextField {
        ...
        style: TextFieldStyle {
            ...
            selectionColor: "#3daee9"           // The text highlight color
            placeholderTextColor:"#3daee9"      // When the text field is empty
            background: Rectangle {
                color: "#e4f9fd"
                radius: 2
                                                    //focus   //normal
                border.color: control.activeFocus ? "#3daee9" : '#204d71'
                border.width: 1
                implicitWidth: 100
                implicitHeight: 30
            }
    ...
    PlasmaComponents.Button {
        ...
        style: ButtonStyle {
            background: Rectangle {
                border.width: 1
                                                    //focus   //normal
                border.color: control.activeFocus ? "#204d71" : '#3daee9'
                radius: 2
                gradient: Gradient {                                      //pressed   //normal
                    GradientStop { position: 0 ; color: control.pressed ? "#204d71" : "#3daee9" }
                    GradientStop { position: 1 ; color: control.pressed ? "#3daee9" : "#204d71" }
                }
                //implicitWidth: 100
                implicitHeight: 30
            }
