...
// 		}
	...
	Timer {
            ...
            onTriggered: {
                fondo1.opacity = loginScreenRoot.uiVisible ? 0.6 : 1
		        fondo2.opacity = loginScreenRoot.uiVisible ? 0.6 : 1
		        fondo3.opacity = loginScreenRoot.uiVisible ? 0.6 : 1
		        fondo4.opacity = loginScreenRoot.uiVisible ? 0.6 : 1
...
// 		        fondo5.opacity = (Math.floor(Math.random() *5) +1 == 5) ?1 : 0
    ...
    MouseArea {
        ...
        Rectangle {
            ...
            color: "#ffffeb"
//             opacity: 0.5
            opacity: loginScreenRoot.uiVisible?0.3:0
